...
- Materialización completada: los tres registros viven en
  ...
  `("item","items")` y el dataset avanza a `2026-09-16.1`. Application consume
  el catálogo en la vertical acotada de UC-04
  (`docs/04-domain/items-consumption-design.md`).
