...
dos veces los treinta y cuatro fixtures más la prueba de formatos `uri`/`date`. También
...
El harness enlazado al validador ejecuta los diecisiete contratos actuales: 34/34
