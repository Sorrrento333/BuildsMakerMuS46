...
dos veces los treinta y dos fixtures más la prueba de formatos `uri`/`date`. También
...
El harness enlazado al validador ejecuta los dieciséis contratos actuales: 32/32
