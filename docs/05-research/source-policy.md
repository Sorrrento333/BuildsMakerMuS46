...
- La autoridad del editor no elimina el control de versión: cada extracción
  debe indicar si demuestra directamente el corte objetivo, confirma un nombre
  persistente o sólo aporta contexto de otra versión.
- Cuando Webzen no permita fijar la versión, se conserva el dato con confianza
  limitada y se contrasta con evidencia técnica independiente.

## Fuente para ítems

- MU Online Fanz Item Database: `https://muonlinefanz.com/tools/items/`.
- Sigue siendo obligatorio contrastar la temporada y exactitud de cada dato.

## Requisitos por registro
- URL canónica.
- Título y autor/editor cuando exista.
- Fecha de consulta.
- Temporada declarada.
- Fragmento o dato extraído.
- Transformación aplicada.
- Licencia/condición de uso conocida.
- Hash o snapshot cuando sea legal.

## Conflictos
No elegir silenciosamente. Crear `DisputeRecord` con versiones enfrentadas, impacto y plan de resolución.

## Caducidad
Los datos históricos de Season 4 no caducan por actualidad, pero las páginas pueden cambiar; se conserva fecha y snapshot de evidencia permitido.
